 ...
 */
	...
	function faf_home_add_hero() {
		echo '<div id="home-hero"><img src="'. get_home_url() .'/wp-content/uploads/2016/03/home1-Chartreuse-Traditional-Industrial-Dining-Room.jpg" alt="Chartreuse Traditional Dining Room" /></div><div class="cta-group" id="hero-cta-group"><p>Real people<br> live here.</p><h1>Interior Design and Unique Home Furnishings for the Greater Raleigh Area</h1><a class="button">Interior Design Services</a><a class="button button-light">The Shop</a></div>';
	}
